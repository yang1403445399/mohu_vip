      ...
      >
        ...
        <div class="flex">
          ...
          <el-button
            ...
            type="primary"
            plain
            @click.stop.prevent="onImageUse(imageData.checked.list)"
            >使用</el-button
          >
        </div>
      </div>
      <div class="flex-1 overflow-auto" v-loading="imageData.load">
        ...
        >
          <el-checkbox
            ...
            border
          >
            <el-image class="w-full h-full" :src="value.url" fit="contain" />
          </el-checkbox>
        </el-checkbox-group>
